...
class DetailsView: UIView {
    ...
    private func addSubviews() {
        ...
        * 8).isActive = true
        ...
        NSLayoutConstraint(item: favoriteButton, attribute: .trailing, relatedBy: .equal, toItem: messageButton, attribute: .leading, multiplier: 1.0, constant: -Constants.regularSpace * 4).isActive = true
        ...
        NSLayoutConstraint(item: shareButton, attribute: .leading, relatedBy: .equal, toItem: messageButton, attribute: .trailing, multiplier: 1.0, constant: Constants.regularSpace * 4).isActive = true
